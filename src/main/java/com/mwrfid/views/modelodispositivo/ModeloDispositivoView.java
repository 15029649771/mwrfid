...
public class ModeloDispositivoView extends Div implements BeforeEnterObserver {
    ...
    public ModeloDispositivoView(@Autowired ModeloDispositivoService modeloDispositivoService) {
        ...
        grid.addColumn("modelodispositivo").setAutoWidth(true).setHeader("Modelo");
        ...
        guardar.addClickListener(e -> {
            try {
                ...
                if (this.modeloDispositivo == null) {
                    ...
                    this.modeloDispositivo.setUsuarioalt(usuario);
                    this.modeloDispositivo.setFechaalt(now);
                 } else {
                this.modeloDispositivo.setFechaact(now);
                this.modeloDispositivo.setUsuarioact(usuario);
                }
    ...
    private Button auditButton(Grid<ModeloDispositivo> grid, ModeloDispositivo item) {
